...
public class TimeHandler {
        ...
        public static final String TABLE_CREATE = "create table time (time_id text not null, startTime int not null, timeBuff int not null);";
        ...
        public boolean updateTime(String id, long newStartTime, long newTimeBuff)
        {
            ContentValues content = new ContentValues();
        ...
        {
            return db.query(TABLE_NAME, new String[]{ID,START_TIME,TIME_BUFF}, null, null, null, null, null);
        }
